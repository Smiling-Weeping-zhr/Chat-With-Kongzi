...
def save_merge_json(data_lis, file_path):
    ...
    with open(file_path, 'wt', encoding='utf-8') as file:
        json.dump(data_lis, file, ensure_ascii=False, indent=4)
...
if __name__ == '__main__':
    ...
    # for path in get_all_file_paths('Text/'):
    #    print(path)
    path_file = 'a0.jsonl'
    ...
    save_merge_json(data_lis=conversion_lis, file_path='a_merge.jsonl')
    # save_merge_json(data_lis=conversion_lis, file_path='json数据集/{}'.format(path_file))